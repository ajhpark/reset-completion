 ...
 */
    ...
    if ($confirm) {    
        ...
        echo $OUTPUT->header();
        $buttoncontinue = new single_button(new moodle_url('/blocks/resetcompletion/reset_user_completion.php', array('course'=>$courseid, 'confirm'=>1, 'sesskey'=>sesskey())), get_string('yes'), 'get');
